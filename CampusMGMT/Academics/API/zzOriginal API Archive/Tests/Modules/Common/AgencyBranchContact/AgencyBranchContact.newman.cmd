...
set CollectionFileName=AgencyBranchContact.postman_collection.json
set DataFileName=AgencyBranchContact.data.json
set EnvironmentFilePath=%TestLocation%\..\..\..\..\Environment\TeamDeepak-StudentAPIEnvironment.postman_environment.json
set GlobalsFilePath=%TestLocation%\..\..\..\..\Environment\CmcUtility.postman_globals.json
set HtmlResultsFile=Common_AgencyBranchContact_Html.html
set JunitResultsFile=Common_AgencyBranchContact_Junit.xml

...
set CollectionFileName=PackagingMethod_Validations.postman_collection.json
set DataFileName=PackagingMethodValidations.data.json
set EnvironmentFilePath=%TestLocation%\..\..\..\..\Environment\TeamDeepak-StudentAPIEnvironment.postman_environment.json
set GlobalsFilePath=%TestLocation%\..\..\..\..\Environment\CmcUtility.postman_globals.json
set HtmlResultsFile=FinancialAid_PackagingMethodValidations_Html.html
set JunitResultsFile=FinancialAid_PackagingMethodValidations_Junit.xml

...
namespace Postman.Wrapper
{
    ...
    public class PostmanWrapper
    {
        ...
        private string EnvironmentFilePath
        {
            ...
            //        _environmentFilePath = SearchFile("APISmokeTest_PostmanTests", "*.postman_environment.json");
        ...
        {
            var directories = Directory.GetDirectories(SolutionDirectory, "APISmokeTest_PostmanTests", SearchOption.TopDirectoryOnly);
            if (!directories.Any())
                return string.Empty;
